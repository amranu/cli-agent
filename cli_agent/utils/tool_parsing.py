...
class ToolCallParser:
    ...
    @staticmethod
    def create_tool_call_object(name: str, args: str, call_id: str = None) -> SimpleNamespace:
...
class GeminiToolCallParser(ToolCallParser):
                ...
                if hasattr(candidate, 'content') and hasattr(candidate.content, 'parts'):
                    for part in candidate.content.parts:
                        if hasattr(part, 'function_call'):
                            ...
                            tool_call = cls.create_tool_call_object(
                                name=func_call.name,
                                args=json.dumps(dict(func_call.args)) if func_call.args else "{}",
    ...
    @classmethod
    def parse_all_formats(cls, response: Any, text_content: str = "") -> List[SimpleNamespace]:
