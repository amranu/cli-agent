...
class EventEmitter:
    ...
    async def emit_text(self, content: str, is_streaming: bool = False, 
                       is_markdown: bool = True, chunk_id: Optional[str] = None):
        """Emit a text event."""
        event = TextEvent(
            event_id="",
            timestamp=datetime.now(),
    ...
    async def emit_tool_call(self, tool_name: str, tool_id: str, 
    ...
    async def emit_tool_result(self, tool_id: str, tool_name: str, result: str,
                              is_error: bool = False, execution_time: Optional[float] = None):
    ...
    async def emit_status(self, status: str, details: Optional[str] = None, 
                         level: str = "info"):
        """Emit a status event."""
        event = StatusEvent(
            event_id="",
    ...
    async def emit_tool_execution_start(self, tool_name: str, tool_id: str, 
                                       arguments: Dict[str, Any], streaming_mode: bool = False):
    ...
    async def emit_system_message(self, message: str, message_type: str = "info", 
                                 emoji: Optional[str] = None):
    ...
    async def emit_ui_status(self, status_text: str, status_type: str = "info", 
