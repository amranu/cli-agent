...
class TestBuiltinTools:
    ...
    def test_tool_categories(self):
        ...
        # File operations
        file_tools = ["read_file", "write_file", "list_directory", "get_current_directory", "replace_in_file"]
    ...
    def test_tool_descriptions_quality(self):
        ...
        for tool_key, tool_def in tools.items():
            ...
            action_words = ["execute", "read", "write", "list", "get", "manage", "fetch", "emit", "spawn", "check", "replace", "retrieve"]
            assert any(word in description.lower() for word in action_words), f"Tool {tool_key} description '{description}' should contain an action word"
